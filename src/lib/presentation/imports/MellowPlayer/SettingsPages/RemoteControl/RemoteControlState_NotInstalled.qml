...
RemoteControlState {
    ...
    message:  qsTr("Install <b>%1</b> to finish Remote Control Setup").arg(RemoteControlViewModel.appInfo.name)
    icon: MaterialIcons.icon_get_app
    buttonText: qsTr("Install ") + RemoteControlViewModel.appInfo.name
    ...
    onButtonClicked: RemoteControlViewModel.install()
}
