...
RemoteControlViewModel::RemoteControlViewModel(IRemoteControl& remoteControl, IContextProperties& contextProperties)
        : ContextProperty("_remoteControl", this, contextProperties),
