...
SCENARIO("releases validity can be tested")
{
    ...
    {
        Release release(
                "https://github.com/ColinDuquesnoy/MellowPlayer/releases/tag/2.95.0", "2.95.0", QDate::fromString("2117-07-15", Qt::ISODate), AssetList());
    ...
    {
        AssetList assets;
        assets << Asset("MellowPlayer_Setup.exe", "MellowPlayer_Setup.exe");
        // windows installer is missing.
        Release release("https://github.com/ColinDuquesnoy/MellowPlayer/releases/tag/2.95.0", "2.95.0", QDate::fromString("2117-07-15", Qt::ISODate), assets);
    ...
    {
        AssetList assets;
        assets << Asset("MellowPlayer.dmg",
                        "https://github.com/ColinDuquesnoy/"
                        "MellowPlayer/releases/tag/2.95.0/"
                        "MellowPlayer.dmg");
        assets << Asset("MellowPlayer_Setup.exe",
                        "https://github.com/ColinDuquesnoy/MellowPlayer/releases/"
                        "tag/2.95.0/MellowPlayer_Setup.exe");
        Release release("https://github.com/ColinDuquesnoy/MellowPlayer/releases/tag/2.95.0", "2.95.0", QDate::fromString("2017-07-15", Qt::ISODate), assets);
